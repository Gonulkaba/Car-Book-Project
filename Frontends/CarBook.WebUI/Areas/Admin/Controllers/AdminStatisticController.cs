...
namespace CarBook.WebUI.Areas.Admin.Controllers
{
	...
	public class AdminStatisticController : Controller
	{
        ...
        public async Task<IActionResult> Index()
        {
            ...
            #region İstatistik2
            var responseMessage2 = await client.GetAsync("http://localhost:5000/api/Statistics/GetLocationCount");
            ...
            #region İstatistik3
            var responseMessage3 = await client.GetAsync("http://localhost:5000/api/Statistics/GetAuthorCount");
            ...
            #region İstatistik4
            var responseMessage4 = await client.GetAsync("http://localhost:5000/api/Statistics/GetBlogCount");
            ...
            #region İstatistik5
            var responseMessage5 = await client.GetAsync("http://localhost:5000/api/Statistics/GetBrandCount");
            ...
            #region İstatistik6
            var responseMessage6 = await client.GetAsync("http://localhost:5000/api/Statistics/GetAvgRentPriceForDaily");
            ...
            #region İstatistik7
            var responseMessage7 = await client.GetAsync("http://localhost:5000/api/Statistics/GetAvgRentPriceForWeekly");
            ...
            #region İstatistik8
            var responseMessage8 = await client.GetAsync("http://localhost:5000/api/Statistics/GetAvgRentPriceForMonthly");
            ...
            #region İstatistik9
            var responseMessage9 = await client.GetAsync("http://localhost:5000/api/Statistics/GetCarCountByTranmissionIsAuto");
            ...
            #region İstatistik13
            var responseMessage13 = await client.GetAsync("http://localhost:5000/api/Statistics/GetCarCountByFuelGasolineOrDiesel");
            ...
            #region İstatistik14
            var responseMessage14 = await client.GetAsync("http://localhost:5000/api/Statistics/GetCarCountByFuelElectric");
