...
namespace CarBook.Application.Validators.ReviewValidators
{
	public class UpdateReviewValidator : AbstractValidator<UpdateReviewCommand>
	{
		public UpdateReviewValidator()
		{
			...
			RuleFor(x => x.Comment).NotEmpty().WithMessage("Lütfen yorum giriniz1");
			RuleFor(x => x.Comment).MinimumLength(25).WithMessage("Lütfen en az 25 karakter yorum giriniz1");
			RuleFor(x => x.Comment).MaximumLength(500).WithMessage("Lütfen en fazla 500 karakter yorum giriniz!");
